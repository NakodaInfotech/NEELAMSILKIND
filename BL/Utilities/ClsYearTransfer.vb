...
#Region "OTHERS"
    ...
    Public Function TRANSFERDESIGNCARD() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERDESIGNCARD"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERSAMPLE() As Integer
        Dim intResult As Integer
        Try

            Dim strCommand As String = "SP_UTILITIES_TRANSFERSAMPLE"
            Dim alParameter As New ArrayList
            With alParameter
...
#Region "BILLS"
    ...
    Public Function TRANSFERYARNSALEORDER() As Integer
        Dim intResult As Integer
        Try
            'save NONPURCHASE 
            Dim strCommand As String = "SP_UTILITIES_TRANSFERYARNSALEORDER"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function TRANSFERYARNDYEINGPROG() As Integer
        Dim intResult As Integer
        Try
            'save NONPURCHASE 
            Dim strCommand As String = "SP_UTILITIES_TRANSFERYARNDYEINGPROG"
            Dim alParameter As New ArrayList
            With alParameter
