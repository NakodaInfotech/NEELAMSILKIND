...
Public Class ClsOpeningStockYarn
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_MASTER_STOCKMASTERYARN_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_MASTER_STOCKMASTERYARN_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_MASTER_STOCKMASTERYARN_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
