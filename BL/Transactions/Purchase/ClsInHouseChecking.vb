...
Public Class ClsInHouseChecking
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_PURCHASE_INHOUSECHECKING_SAVE"
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@CHECKEDBY", alParaval(I)))
                I = I + 1

                .Add(New SqlClient.SqlParameter("@TOTALGREYMTRS", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_PURCHASE_INHOUSECHECKING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTCHECKING(ByVal CHECKINGNO As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTINHOUSECHECKING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_PURCHASE_INHOUSECHECKING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
