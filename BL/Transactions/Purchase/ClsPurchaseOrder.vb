...
#Region "Functions"
    ...
    Public Function save() As DataTable
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_PURCHASE_PURCHASEORDER_SAVE"
    ...
    Public Function save_amendedPO() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_PURCHASE_PURCHASEORDER_SAVE_POAMENDED"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_PURCHASE_PURCHASEORDER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                Dim I As Integer = 0
                .Add(New SqlClient.SqlParameter("@podate", alParaval(I)))
    ...
    Public Function selectpo(ByVal pono As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTPO_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_PURCHASE_PURCHASEORDER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function closepo() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_PURCHASE_PURCHASEORDER_CLOSEPO"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@pono", alParaval(0)))
