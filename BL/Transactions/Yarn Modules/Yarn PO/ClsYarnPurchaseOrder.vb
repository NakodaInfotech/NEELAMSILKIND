...
Public Class ClsYarnPurchaseOrder
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_YARNPURCHASEORDER_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_YARNPURCHASEORDER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                Dim I As Integer = 0
                .Add(New SqlClient.SqlParameter("@podate", alParaval(I)))
    ...
    Public Function SELECTPO(ByVal pono As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTYARNPURCHASEORDER_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_YARNPURCHASEORDER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
