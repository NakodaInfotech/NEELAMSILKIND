...
Public Class ClsYarndyeingProgram
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_YARNDYEINGPROGRAM_SAVE"
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@FROMYARNQUALITY", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@FROMSHADE", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@REDYEING", alParaval(I)))
                I = I + 1
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@MRPSRNO", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_YARNDYEINGPROGRAM_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTPROGRAM(ByVal PROGRAMNO As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTYARNDYEINGPROGRAM_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@PROGRAMNO", PROGRAMNO))
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_YARNDYEINGPROGRAM_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
