...
Public Class ClsYarnRecdFromDyeing
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_YARNRECDDYEING_SAVE"
            ...
            With alParameter
                ...
                'SOURCEGRID
                .Add(New SqlClient.SqlParameter("@SOURCESRNO", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@SOURCEYARNQUALITY", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@SOURCECOLOR", alParaval(I)))
                I = I + 1
                .Add(New SqlClient.SqlParameter("@SOURCEWT", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_YARNRECDDYEING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SAVEUPLOAD() As Integer
        ...
        Try
            ...
            strcommand = "SP_TRANS_YARNRECDDYEING_SAVEUPLOAD"
    ...
    Public Function SELECTYARN(ByVal YARNNO As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTYARNRECDDYEING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_YARNRECDDYEING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
