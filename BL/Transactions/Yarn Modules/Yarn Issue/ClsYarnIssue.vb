...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_YARNISSUE_SAVE"
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@MANUALAMT", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_YARNISSUE_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SAVEUPLOAD() As Integer
        ...
        Try
            ...
            strcommand = "SP_TRANS_YARNISSUE_SAVEUPLOAD"
    ...
    Public Function SELECTYARN(ByVal YARNNO As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTYARNISSUE_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_YARNISSUE_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
