...
Public Class ClsYarnReturnKnitting
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_YARNKNITTINGRETURN_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_YARNKNITTINGRETURN_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SAVEUPLOAD() As Integer
        ...
        Try
            ...
            strcommand = "SP_TRANS_YARNKNITTINGRETURN_SAVEUPLOAD"
    ...
    Public Function SELECTYARNKNITTING(ByVal PRODNO As Integer, ByVal Cmpid As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTYARNKNITTINGRETURN_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_YARNKNITTINGRETURN_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
