...
Public Class ClsColorTypeMaster
...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            'save COLORTYPE Master
            Dim strCommand As String = "SP_MASTER_COLORTYPEMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@COLORTYPEname", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save COLORTYPE Master
            Dim strCommand As String = "SP_MASTER_COLORTYPEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@COLORTYPEid", alParaval(7)))
