...
Public Class AccountsDetails
    ...
    Private Sub AccountsDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        ElseIf (e.Alt = True And e.KeyCode =System.WINDOWS.FORMS.Keys.X) Or (e.KeyCode =System.WINDOWS.FORMS.Keys.Escape) Then   'for Exit
            Me.Close()
        ElseIf (e.Control = True And e.KeyCode =System.WINDOWS.FORMS.Keys.N) Or (e.Alt = True And e.KeyCode =System.WINDOWS.FORMS.Keys.A) Then       'for AddNew 
    ...
    Private Sub PBENVELOP_Click(sender As Object, e As EventArgs) Handles PBENVELOP.Click
        ...
        If TEMPMSG2 = vbYes Then
            ...
            OBJENV.LEDGERSNAME = gridledger.GetFocusedRowCellValue("NAME")
