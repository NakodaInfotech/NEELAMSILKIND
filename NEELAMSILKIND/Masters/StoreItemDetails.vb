...
Public Class StoreItemDetails
    ...
    Private Sub StoreItemDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
            If (e.KeyCode =System.WINDOWS.FORMS.Keys.Escape) Then   'for Exit
                Me.Close()
            ElseIf (e.Control = True And e.KeyCode =System.WINDOWS.FORMS.Keys.N) Then
                SHOWFORM(False, "")
    ...
    Private Sub StoreItemDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub FILLGRID()
        Try
            ...
            DTTABLE = objClsCommon.search(" STOREITEM_NAME AS [Item Name], STOREITEM_ID ", "", " STOREITEMMASTER ", " AND STOREITEM_YEARID = " & YearId)
            If DTTABLE.Rows.Count > 0 Then
                GRID.DataSource = DTTABLE
                GRID.Columns(1).Visible = False
                GRID.Columns(0).Width = 250
                GRID.Columns(0).SortMode =System.WINDOWS.FORMS.DataGridViewColumnSortMode.Automatic
            End If
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Sub SHOWFORM(ByVal EDITVAL As Boolean, ByVal ID As Integer)
        Try
            ...
            Dim OBJSELECT As New StoreItemMaster
