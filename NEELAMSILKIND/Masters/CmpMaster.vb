        ...
        Try
            If (EDIT = False) Or (EDIT = True And TEMPCMPNAME <> txtcmpname.Text.Trim) Then
                ...
                If dt.Rows.Count > 0 Then
                    MsgBox("Company Name Already Exists", MsgBoxStyle.Critical, "NEELAMSILKIND")
                    e.Cancel = True
                End If
        ...
        Try
            If cmbcountry.Text.Trim <> "" Then
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    Dim tempmsg As Integer = MsgBox("Country not present, Add New?", MsgBoxStyle.YesNo, "NEELAMSILKIND")
                    If tempmsg = vbYes Then
                        cmbcountry.Text = a
