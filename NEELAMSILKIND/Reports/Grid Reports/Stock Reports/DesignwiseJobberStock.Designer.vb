...
Partial Class DesignwiseJobberStock
    ...
    Private Sub InitializeComponent()
        ...
        Me.gridbill.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GNAME, Me.GDESIGNNO, Me.GCATEGORYNAME, Me.DTOTALMTRS})
