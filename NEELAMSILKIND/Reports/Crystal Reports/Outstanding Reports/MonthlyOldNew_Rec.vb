...
Public Class MonthlyOldNew_Rec
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.MonthlyOldNew_Rec.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyOldNew_Rec
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyOldNew_Rec = New MonthlyOldNew_Rec()
        rpt.Site = Me.Site
        Return rpt
    End Function
