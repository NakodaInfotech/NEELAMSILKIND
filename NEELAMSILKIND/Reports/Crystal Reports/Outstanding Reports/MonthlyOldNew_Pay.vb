...
Public Class MonthlyOldNew_Pay
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.MonthlyOldNew_Pay.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyOldNew_Pay
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyOldNew_Pay = New MonthlyOldNew_Pay()
        rpt.Site = Me.Site
        Return rpt
    End Function
