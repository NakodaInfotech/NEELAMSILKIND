...
Public Class IssueToPackingReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "IssueToPackingReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.IssueToPackingReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIssueToPackingReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IssueToPackingReport = New IssueToPackingReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
