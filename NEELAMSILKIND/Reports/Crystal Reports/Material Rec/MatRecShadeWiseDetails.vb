...
Public Class MatRecShadeWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MatRecShadeWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.MatRecShadeWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMatRecShadeWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MatRecShadeWiseDetails = New MatRecShadeWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
