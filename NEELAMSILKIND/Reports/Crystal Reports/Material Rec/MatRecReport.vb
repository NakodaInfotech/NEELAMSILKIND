...
Public Class MatRecReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.MatRecReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMatRecReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MatRecReport = New MatRecReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
