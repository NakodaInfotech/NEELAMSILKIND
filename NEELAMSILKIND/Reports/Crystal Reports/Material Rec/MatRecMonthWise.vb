...
Public Class MatRecMonthWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.MatRecMonthWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMatRecMonthWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MatRecMonthWise = New MatRecMonthWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
