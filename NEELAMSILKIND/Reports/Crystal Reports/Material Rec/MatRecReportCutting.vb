...
Public Class MatRecReportCutting
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MatRecReportCutting.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.MatRecReportCutting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMatRecReportCutting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MatRecReportCutting = New MatRecReportCutting()
        rpt.Site = Me.Site
        Return rpt
    End Function
