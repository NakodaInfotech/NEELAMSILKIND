...
Public Class SaleRetTransWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SaleRetTransWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SaleRetTransWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleRetTransWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleRetTransWiseDetails = New SaleRetTransWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
