...
Public Class GroupWiseTransdtls
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GroupWiseTransdtls.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGroupWiseTransdtls
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GroupWiseTransdtls = New GroupWiseTransdtls()
        rpt.Site = Me.Site
        Return rpt
    End Function
