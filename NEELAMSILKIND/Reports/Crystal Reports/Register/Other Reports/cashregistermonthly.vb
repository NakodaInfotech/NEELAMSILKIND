...
Public Class cashregistermonthly
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cashregistermonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.cashregistermonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CASHNAME() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcashregistermonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cashregistermonthly = New cashregistermonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
