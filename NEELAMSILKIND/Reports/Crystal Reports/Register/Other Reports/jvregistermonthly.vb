...
Public Class jvregistermonthly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.jvregistermonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedjvregistermonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As jvregistermonthly = New jvregistermonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
