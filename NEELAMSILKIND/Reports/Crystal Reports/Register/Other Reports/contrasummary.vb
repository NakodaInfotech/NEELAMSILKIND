...
Public Class contrasummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.contrasummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcontrasummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As contrasummary = New contrasummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
