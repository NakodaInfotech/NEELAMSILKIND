...
Public Class saletaxreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.saletaxreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsaletaxreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As saletaxreport = New saletaxreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
