...
Public Class groupwisetrans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.groupwisetrans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgroupwisetrans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As groupwisetrans = New groupwisetrans()
        rpt.Site = Me.Site
        Return rpt
    End Function
