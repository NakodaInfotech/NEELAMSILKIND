...
Public Class SaleRegisterReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SaleRegisterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_REGNAME() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSaleRegisterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleRegisterReport = New SaleRegisterReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
