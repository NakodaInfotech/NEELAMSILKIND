...
Public Class InterestSummReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.InterestSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInterestSummReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InterestSummReport = New InterestSummReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
