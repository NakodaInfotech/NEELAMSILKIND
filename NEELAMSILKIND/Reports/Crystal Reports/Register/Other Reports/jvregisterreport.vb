...
Public Class jvregisterreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.jvregisterreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedjvregisterreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As jvregisterreport = New jvregisterreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
