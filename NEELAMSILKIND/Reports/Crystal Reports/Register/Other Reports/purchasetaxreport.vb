...
Public Class purchasetaxreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.purchasetaxreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpurchasetaxreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As purchasetaxreport = New purchasetaxreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
