...
Public Class LedgerBookAcc_Desc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.LedgerBookAcc_Desc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLedgerBookAcc_Desc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LedgerBookAcc_Desc = New LedgerBookAcc_Desc()
        rpt.Site = Me.Site
        Return rpt
    End Function
