...
Public Class LedgerBookAcReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.LedgerBookAcReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLedgerBookAcReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LedgerBookAcReport = New LedgerBookAcReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
