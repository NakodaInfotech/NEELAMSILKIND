...
Public Class SOPartyWiseSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SOPartyWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOPartyWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOPartyWiseSummary = New SOPartyWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
