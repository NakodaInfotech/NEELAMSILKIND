...
Public Class SOCutWiseDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SOCutWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOCutWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOCutWiseDetails = New SOCutWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
