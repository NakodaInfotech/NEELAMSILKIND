...
Public Class SOTransWiseSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SOTransWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOTransWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOTransWiseSummary = New SOTransWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
