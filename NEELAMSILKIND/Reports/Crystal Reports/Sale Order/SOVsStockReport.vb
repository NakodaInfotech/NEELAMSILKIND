...
Public Class SOVsStockReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SOVsStockReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOVsStockReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOVsStockReport = New SOVsStockReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
