...
Public Class SOAgentWiseSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SOAgentWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOAgentWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOAgentWiseSummary = New SOAgentWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
