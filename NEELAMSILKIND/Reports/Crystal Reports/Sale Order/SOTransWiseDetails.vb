...
Public Class SOTransWiseDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SOTransWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOTransWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOTransWiseDetails = New SOTransWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
