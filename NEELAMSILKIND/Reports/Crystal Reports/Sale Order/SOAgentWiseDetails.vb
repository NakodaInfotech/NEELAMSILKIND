...
Public Class SOAgentWiseDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SOAgentWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOAgentWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOAgentWiseDetails = New SOAgentWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
