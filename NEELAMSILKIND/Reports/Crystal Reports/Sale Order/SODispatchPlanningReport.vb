...
Public Class SODispatchPlanningReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SODispatchPlanningReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SODispatchPlanningReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSODispatchPlanningReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SODispatchPlanningReport = New SODispatchPlanningReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
