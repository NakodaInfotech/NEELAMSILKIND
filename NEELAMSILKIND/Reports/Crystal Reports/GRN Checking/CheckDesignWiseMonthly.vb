...
Public Class CheckDesignWiseMonthly
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CheckDesignWiseMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.CheckDesignWiseMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCheckDesignWiseMonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CheckDesignWiseMonthly = New CheckDesignWiseMonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
