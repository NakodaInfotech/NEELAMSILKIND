...
Public Class CheckMonthWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.CheckMonthWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCheckMonthWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CheckMonthWise = New CheckMonthWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
