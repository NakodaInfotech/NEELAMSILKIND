...
Public Class CheckItemWiseMonthly
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CheckItemWiseMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.CheckItemWiseMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCheckItemWiseMonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CheckItemWiseMonthly = New CheckItemWiseMonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
