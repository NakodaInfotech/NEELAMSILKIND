...
Public Class CheckPartyWiseMonthly
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CheckPartyWiseMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.CheckPartyWiseMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCheckPartyWiseMonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CheckPartyWiseMonthly = New CheckPartyWiseMonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
