...
Public Class CheckJobberWiseMonthly
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CheckJobberWiseMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.CheckJobberWiseMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCheckJobberWiseMonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CheckJobberWiseMonthly = New CheckJobberWiseMonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
