...
Public Class CheckPartyWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CheckPartyWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.CheckPartyWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCheckPartyWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CheckPartyWiseDetails = New CheckPartyWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
