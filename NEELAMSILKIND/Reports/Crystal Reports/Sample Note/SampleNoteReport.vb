...
Public Class SampleNoteReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.SampleNoteReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSampleNoteReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SampleNoteReport = New SampleNoteReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
