...
Public Class StickerLabelReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.StickerLabelReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStickerLabelReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StickerLabelReport = New StickerLabelReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
