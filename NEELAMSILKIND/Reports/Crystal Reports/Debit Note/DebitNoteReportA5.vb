...
Public Class DebitNoteReportA5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.DebitNoteReportA5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDebitNoteReportA5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DebitNoteReportA5 = New DebitNoteReportA5()
        rpt.Site = Me.Site
        Return rpt
    End Function
