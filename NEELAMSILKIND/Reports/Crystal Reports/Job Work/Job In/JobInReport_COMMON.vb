...
Public Class JobInReport_COMMON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.JobInReport_COMMON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJobInReport_COMMON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JobInReport_COMMON = New JobInReport_COMMON()
        rpt.Site = Me.Site
        Return rpt
    End Function
