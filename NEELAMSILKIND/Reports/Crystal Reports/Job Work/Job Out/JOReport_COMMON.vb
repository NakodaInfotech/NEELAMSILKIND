...
Public Class JOReport_COMMON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.JOReport_COMMON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOReport_COMMON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOReport_COMMON = New JOReport_COMMON()
        rpt.Site = Me.Site
        Return rpt
    End Function
