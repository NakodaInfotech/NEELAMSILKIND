...
Public Class ReceiptBillWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.ReceiptBillWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReceiptBillWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReceiptBillWise = New ReceiptBillWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
