...
Public Class LotWiseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.LotWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotWiseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotWiseReport = New LotWiseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
