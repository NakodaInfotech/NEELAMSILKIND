...
Public Class GRNPartyWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GRNPartyWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GRNPartyWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNPartyWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNPartyWiseDetails = New GRNPartyWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
