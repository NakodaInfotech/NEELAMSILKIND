...
Public Class GRNMonthWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GRNMonthWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNMonthWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNMonthWise = New GRNMonthWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
