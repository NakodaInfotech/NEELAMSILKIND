...
Public Class GRNDesignWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GRNDesignWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GRNDesignWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNDesignWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNDesignWiseDetails = New GRNDesignWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
