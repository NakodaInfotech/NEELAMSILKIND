...
Public Class GRNPendingCheck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GRNPendingCheck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNPendingCheck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNPendingCheck = New GRNPendingCheck()
        rpt.Site = Me.Site
        Return rpt
    End Function
