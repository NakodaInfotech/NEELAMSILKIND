...
Public Class GRNShadeWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GRNShadeWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GRNShadeWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNShadeWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNShadeWiseDetails = New GRNShadeWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
