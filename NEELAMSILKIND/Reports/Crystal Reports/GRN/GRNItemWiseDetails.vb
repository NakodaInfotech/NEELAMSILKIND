...
Public Class GRNItemWiseDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GRNItemWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNItemWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNItemWiseDetails = New GRNItemWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
