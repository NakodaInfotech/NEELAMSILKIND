...
Public Class POPartyWiseSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.POPartyWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOPartyWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POPartyWiseSummary = New POPartyWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
