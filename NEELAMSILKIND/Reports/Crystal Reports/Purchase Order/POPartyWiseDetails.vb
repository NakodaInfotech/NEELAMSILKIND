...
Public Class POPartyWiseDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.POPartyWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOPartyWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POPartyWiseDetails = New POPartyWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
