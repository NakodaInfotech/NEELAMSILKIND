...
Public Class POCutWiseDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.POCutWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOCutWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POCutWiseDetails = New POCutWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
