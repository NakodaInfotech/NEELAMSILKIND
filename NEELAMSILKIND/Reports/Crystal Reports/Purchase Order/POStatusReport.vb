...
Public Class POStatusReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.POStatusReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOStatusReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POStatusReport = New POStatusReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
