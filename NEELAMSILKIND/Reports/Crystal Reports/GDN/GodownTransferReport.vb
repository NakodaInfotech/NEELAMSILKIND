...
Public Class GodownTransferReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GodownTransferReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GodownTransferReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGodownTransferReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GodownTransferReport = New GodownTransferReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
