...
Public Class GDNTransReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GDNTransReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNTransReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNTransReport = New GDNTransReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
