...
Public Class GDNTransReportMain
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GDNTransReportMain.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNTransReportMain
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNTransReportMain = New GDNTransReportMain()
        rpt.Site = Me.Site
        Return rpt
    End Function
