...
Public Class GDNReport_COMMON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GDNReport_COMMON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_COMMON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_COMMON = New GDNReport_COMMON()
        rpt.Site = Me.Site
        Return rpt
    End Function
