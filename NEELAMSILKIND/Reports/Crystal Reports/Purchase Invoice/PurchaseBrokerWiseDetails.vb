...
Public Class PurchaseBrokerWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchaseBrokerWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PurchaseBrokerWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchaseBrokerWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseBrokerWiseDetails = New PurchaseBrokerWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
