...
Public Class PurchasePartyWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchasePartyWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PurchasePartyWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchasePartyWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchasePartyWiseDetails = New PurchasePartyWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
