...
Public Class PurchaseEntryWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchaseEntryWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PurchaseEntryWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchaseEntryWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseEntryWiseDetails = New PurchaseEntryWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
