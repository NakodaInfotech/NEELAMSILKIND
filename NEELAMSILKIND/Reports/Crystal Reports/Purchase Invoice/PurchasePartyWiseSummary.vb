...
Public Class PurchasePartyWiseSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchasePartyWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PurchasePartyWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchasePartyWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchasePartyWiseSummary = New PurchasePartyWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
