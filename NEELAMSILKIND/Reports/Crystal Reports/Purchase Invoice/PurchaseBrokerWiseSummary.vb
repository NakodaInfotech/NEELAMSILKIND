...
Public Class PurchaseBrokerWiseSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchaseBrokerWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PurchaseBrokerWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchaseBrokerWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseBrokerWiseSummary = New PurchaseBrokerWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
