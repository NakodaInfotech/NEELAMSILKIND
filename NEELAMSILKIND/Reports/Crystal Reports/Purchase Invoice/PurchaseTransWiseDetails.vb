...
Public Class PurchaseTransWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchaseTransWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PurchaseTransWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchaseTransWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseTransWiseDetails = New PurchaseTransWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
