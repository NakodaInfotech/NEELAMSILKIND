...
Public Class PurchasePartyEntryWiseReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchasePartyEntryWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PurchasePartyEntryWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchasePartyEntryWiseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchasePartyEntryWiseReport = New PurchasePartyEntryWiseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
