...
Public Class PurchaseTransWiseSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchaseTransWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PurchaseTransWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchaseTransWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseTransWiseSummary = New PurchaseTransWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
