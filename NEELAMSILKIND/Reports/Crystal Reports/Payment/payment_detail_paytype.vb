...
Public Class payment_detail_paytype
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "payment_detail_paytype.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.payment_detail_paytype.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpayment_detail_paytype
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As payment_detail_paytype = New payment_detail_paytype()
        rpt.Site = Me.Site
        Return rpt
    End Function
