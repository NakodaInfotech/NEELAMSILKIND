...
Public Class ChqPayment_UNION
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.ChqPayment_UNION.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_UNION
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_UNION = New ChqPayment_UNION()
        rpt.Site = Me.Site
        Return rpt
    End Function
