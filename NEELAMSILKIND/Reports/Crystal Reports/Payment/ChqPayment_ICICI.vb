...
Public Class ChqPayment_ICICI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.ChqPayment_ICICI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_ICICI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_ICICI = New ChqPayment_ICICI()
        rpt.Site = Me.Site
        Return rpt
    End Function
