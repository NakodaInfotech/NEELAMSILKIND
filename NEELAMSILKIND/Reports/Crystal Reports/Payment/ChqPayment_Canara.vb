...
Public Class ChqPayment_Canara
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.ChqPayment_Canara.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_Canara
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_Canara = New ChqPayment_Canara()
        rpt.Site = Me.Site
        Return rpt
    End Function
