...
Public Class ChqPayment_HDFC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.ChqPayment_HDFC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_HDFC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_HDFC = New ChqPayment_HDFC()
        rpt.Site = Me.Site
        Return rpt
    End Function
