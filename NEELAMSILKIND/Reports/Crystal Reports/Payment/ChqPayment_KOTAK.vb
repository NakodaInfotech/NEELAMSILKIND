...
Public Class ChqPayment_KOTAK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.ChqPayment_KOTAK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_KOTAK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_KOTAK = New ChqPayment_KOTAK()
        rpt.Site = Me.Site
        Return rpt
    End Function
