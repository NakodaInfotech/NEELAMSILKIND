...
Public Class PaymentBillWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PaymentBillWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentBillWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentBillWise = New PaymentBillWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
