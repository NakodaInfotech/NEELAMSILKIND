...
Public Class ChqPayment_INDUS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.ChqPayment_INDUS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_INDUS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_INDUS = New ChqPayment_INDUS()
        rpt.Site = Me.Site
        Return rpt
    End Function
