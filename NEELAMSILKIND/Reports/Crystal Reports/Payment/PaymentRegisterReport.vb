...
Public Class PaymentRegisterReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PaymentRegisterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.PaymentRegisterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentRegisterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentRegisterReport = New PaymentRegisterReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
