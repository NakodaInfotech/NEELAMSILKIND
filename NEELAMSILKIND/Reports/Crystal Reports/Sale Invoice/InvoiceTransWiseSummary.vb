...
Public Class InvoiceTransWiseSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceTransWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.InvoiceTransWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceTransWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceTransWiseSummary = New InvoiceTransWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
