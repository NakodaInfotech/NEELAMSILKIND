...
Public Class InvoiceTermWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceTermWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.InvoiceTermWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceTermWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceTermWiseDetails = New InvoiceTermWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
