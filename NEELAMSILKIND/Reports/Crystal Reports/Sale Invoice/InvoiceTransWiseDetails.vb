...
Public Class InvoiceTransWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceTransWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.InvoiceTransWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceTransWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceTransWiseDetails = New InvoiceTransWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
