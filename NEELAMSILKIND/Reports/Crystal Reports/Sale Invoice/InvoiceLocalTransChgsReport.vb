...
Public Class InvoiceLocalTransChgsReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceLocalTransChgsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.InvoiceLocalTransChgsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceLocalTransChgsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceLocalTransChgsReport = New InvoiceLocalTransChgsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
