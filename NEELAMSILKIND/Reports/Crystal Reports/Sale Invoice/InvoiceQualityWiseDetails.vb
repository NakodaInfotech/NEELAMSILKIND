...
Public Class InvoiceQualityWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceQualityWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.InvoiceQualityWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceQualityWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceQualityWiseDetails = New InvoiceQualityWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
