...
Public Class CoverNoteReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.CoverNoteReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCoverNoteReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CoverNoteReport = New CoverNoteReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
