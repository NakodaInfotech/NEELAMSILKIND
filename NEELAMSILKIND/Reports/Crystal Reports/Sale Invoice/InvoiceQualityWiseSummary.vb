...
Public Class InvoiceQualityWiseSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceQualityWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.InvoiceQualityWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceQualityWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceQualityWiseSummary = New InvoiceQualityWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
