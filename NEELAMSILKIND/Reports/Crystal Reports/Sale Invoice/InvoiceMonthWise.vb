...
Public Class InvoiceMonthWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.InvoiceMonthWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceMonthWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceMonthWise = New InvoiceMonthWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
