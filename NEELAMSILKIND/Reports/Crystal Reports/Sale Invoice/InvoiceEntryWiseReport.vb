...
Public Class InvoiceEntryWiseReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceEntryWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.InvoiceEntryWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceEntryWiseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceEntryWiseReport = New InvoiceEntryWiseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
