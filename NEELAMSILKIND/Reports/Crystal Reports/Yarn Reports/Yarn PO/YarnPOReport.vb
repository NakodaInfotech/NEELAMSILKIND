...
Public Class YarnPOReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.YarnPOReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnPOReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnPOReport = New YarnPOReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
