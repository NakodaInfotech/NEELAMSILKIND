...
Public Class YarnSOStatusReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.YarnSOStatusReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnSOStatusReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnSOStatusReport = New YarnSOStatusReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
