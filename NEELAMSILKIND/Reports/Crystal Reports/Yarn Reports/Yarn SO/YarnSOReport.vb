...
Public Class YarnSOReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.YarnSOReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnSOReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnSOReport = New YarnSOReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
