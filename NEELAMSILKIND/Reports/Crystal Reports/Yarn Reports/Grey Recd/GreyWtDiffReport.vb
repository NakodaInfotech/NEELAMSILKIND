...
Public Class GreyWtDiffReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.GreyWtDiffReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGreyWtDiffReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GreyWtDiffReport = New GreyWtDiffReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
