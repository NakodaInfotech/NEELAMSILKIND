...
Public Class YarnRecdReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.YarnRecdReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnRecdReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnRecdReport = New YarnRecdReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
