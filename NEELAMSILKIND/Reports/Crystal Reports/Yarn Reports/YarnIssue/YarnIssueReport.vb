...
Public Class YarnIssueReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.YarnIssueReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnIssueReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnIssueReport = New YarnIssueReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
