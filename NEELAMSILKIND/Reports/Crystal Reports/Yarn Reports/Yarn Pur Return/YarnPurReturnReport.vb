...
Public Class YarnPurReturnReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "YarnPurReturnReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.YarnPurReturnReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnPurReturnReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnPurReturnReport = New YarnPurReturnReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
