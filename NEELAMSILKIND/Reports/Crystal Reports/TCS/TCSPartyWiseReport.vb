...
Public Class TCSPartyWiseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.TCSPartyWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTCSPartyWiseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TCSPartyWiseReport = New TCSPartyWiseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
