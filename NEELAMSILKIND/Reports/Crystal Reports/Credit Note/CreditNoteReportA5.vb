...
Public Class CreditNoteReportA5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.CreditNoteReportA5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCreditNoteReportA5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CreditNoteReportA5 = New CreditNoteReportA5()
        rpt.Site = Me.Site
        Return rpt
    End Function
