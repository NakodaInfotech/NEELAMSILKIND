...
Public Class LotStatus_LEDGERS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.LotStatus_LEDGERS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotStatus_LEDGERS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotStatus_LEDGERS = New LotStatus_LEDGERS()
        rpt.Site = Me.Site
        Return rpt
    End Function
