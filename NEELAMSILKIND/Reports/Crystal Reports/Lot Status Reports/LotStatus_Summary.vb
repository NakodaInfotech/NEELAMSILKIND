...
Public Class LotStatus_Summary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.LotStatus_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotStatus_Summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotStatus_Summary = New LotStatus_Summary()
        rpt.Site = Me.Site
        Return rpt
    End Function
