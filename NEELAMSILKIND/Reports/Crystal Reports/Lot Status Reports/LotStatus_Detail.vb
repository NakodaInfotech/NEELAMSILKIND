...
Public Class LotStatus_Detail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NEELAMSILKIND.LotStatus_Detail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotStatus_Detail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotStatus_Detail = New LotStatus_Detail()
        rpt.Site = Me.Site
        Return rpt
    End Function
