...
Public Class YearTransfer
            ...
            If TEMPMSG = vbYes Then
                ...
                If TEMPMSG = vbYes Then
                    ...
                    If FRMSTRING = "YEARTRANSFER" Then
                        ...
                        TRANSFERDESIGNCARD(SELECTEDYEARID)
                        TRANSFERSAMPLE(SELECTEDYEARID)
                        ...
                        TRANSFERCOLORTAGGING(SELECTEDYEARID)
                        ...
                        TRANSFERYARNSALEORDER(SELECTEDYEARID)
                        TRANSFERYARNPURORDER(SELECTEDYEARID)
                        TRANSFERYARNDYEINGPROG(SELECTEDYEARID)
                        ...
                        Dim INTRES As Integer = CLSRECO.ORDERRECO()
                        '*********************************************
    ...
    Sub TRANSFERDESIGNCARD(ByVal SELECTEDYEARID As Integer)
        Try
            Dim ALPARAVAL As New ArrayList
            ...
            OBJTRF.alParaval = ALPARAVAL
            INTRES = OBJTRF.TRANSFERDESIGNCARD()
        Catch ex As Exception
            Throw ex
        End Try
    End Sub

    Sub TRANSFERSAMPLE(ByVal SELECTEDYEARID As Integer)
        Try
            Dim ALPARAVAL As New ArrayList
    ...
    Sub TRANSFERYARNSALEORDER(ByVal SELECTEDYEARID As Integer)
        Try
            Dim ALPARAVAL As New ArrayList
            ...
            OBJTRF.alParaval = ALPARAVAL
            INTRES = OBJTRF.TRANSFERYARNSALEORDER()
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Sub TRANSFERYARNDYEINGPROG(ByVal SELECTEDYEARID As Integer)
        Try
            Dim ALPARAVAL As New ArrayList
            ...
            OBJTRF.alParaval = ALPARAVAL
            INTRES = OBJTRF.TRANSFERYARNDYEINGPROG()
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
