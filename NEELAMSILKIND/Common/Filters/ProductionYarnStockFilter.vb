...
Public Class ProductionYarnStockFilter
    ...
    Private Sub ProductionYarnStockFilter_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub ProductionYarnStockFilter_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            fillcmb()
        Catch ex As Exception
            Throw ex
    ...
    Private Sub cmdshow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            ...
            If RBSTOCKONHAND.Checked = True Then
                Dim OBJYARNSTOCK As New ProductionYarnStockOnHand
            ...
            OBJSTOCK.WHERECLAUSE = " {PRODUCTIONYARNSTOCKREGISTER.YEARID}=" & YearId
            ...
            If CMBYARNQUALITY.Text.Trim <> "" Then OBJSTOCK.WHERECLAUSE = OBJSTOCK.WHERECLAUSE & " and {PRODUCTIONYARNSTOCKREGISTER.YARNQUALITY}='" & CMBYARNQUALITY.Text.Trim & "'"
            If CMBMILLNAME.Text.Trim <> "" Then OBJSTOCK.WHERECLAUSE = OBJSTOCK.WHERECLAUSE & " and {PRODUCTIONYARNSTOCKREGISTER.MILLNAME}='" & CMBMILLNAME.Text.Trim & "'"
            If CMBDESIGN.Text.Trim <> "" Then OBJSTOCK.WHERECLAUSE = OBJSTOCK.WHERECLAUSE & " and {PRODUCTIONYARNSTOCKREGISTER.DESIGNNO}='" & CMBDESIGN.Text.Trim & "'"
            If CMBSHADE.Text.Trim <> "" Then OBJSTOCK.WHERECLAUSE = OBJSTOCK.WHERECLAUSE & " and {PRODUCTIONYARNSTOCKREGISTER.COLOR}='" & CMBSHADE.Text.Trim & "'"

            If RBYARNQUALITYSUMM.Checked = True Then
                OBJSTOCK.FRMSTRING = "PRODQUALITYSTOCKSUMM"
            ElseIf RBDESIGNSUMM.Checked = True Then
                OBJSTOCK.FRMSTRING = "PRODDESIGNSTOCKSUMM"
            ElseIf RBSHADESUMM.Checked = True Then
                OBJSTOCK.FRMSTRING = "PRODSHADESTOCKSUMM"
            End If
