...
Module Module1
    ...
    'Public DatabaseName As String = "NEELAMSILKIND"          'Used for Servername for reports'
    ...
    Public PENDINGJOTOOLVISIBLE As Boolean
    ...
    Public FETCHITEMWISEDESIGN As Boolean
