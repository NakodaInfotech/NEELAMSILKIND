    ...
    Sub BARCODEPRINTING(BARCODE As String, PIECETYPE As String, ITEMNAME As String, QUALITY As String, DESIGNNO As String, SHADE As String, UNIT As String, LOTNO As String, BALENO As String, GRIDDESC As String, MTRS As Double, QTY As Double, Optional RACK As String = "", Optional TEMPHEADER As String = "", Optional SUPRIYAHEADER As String = "", Optional WHOLESALEBARCODE As Integer = 0, Optional WEAVERCHNO As String = "", Optional WEAVERNAME As String = "")
        Try
            ...
            If ClientName = "NEELAM" Then
                ...
                oWrite.WriteLine("A2")
                oWrite.WriteLine("1911C1001710015DESIGN NO")
                oWrite.WriteLine("1911C1001540015SHADE")
                oWrite.WriteLine("1911C1001360015QUALITY")
                oWrite.WriteLine("1911C1001190015CH NO")
                oWrite.WriteLine("1e6304000230014B" & BARCODE)
                oWrite.WriteLine("1911C1000060106" & BARCODE)
                oWrite.WriteLine("1911C1000850015MTRS")
                oWrite.WriteLine("1911C1000670015TAKA NO")
                oWrite.WriteLine("1911C1001020015" & WEAVERNAME)
                oWrite.WriteLine("1X1100000700227B087049003003")
                oWrite.WriteLine("1911C1000850178MTRS :")
                oWrite.WriteLine("1911C1001710102:")
                oWrite.WriteLine("1911C1001710114" & DESIGNNO)
                oWrite.WriteLine("1911C1001540102:")
                oWrite.WriteLine("1911C1001540114" & SHADE)
                oWrite.WriteLine("1911C1001360102:")
                oWrite.WriteLine("1911C1001360114" & ITEMNAME)
                oWrite.WriteLine("1911C1001190102:")
                oWrite.WriteLine("1911C1001190114" & WEAVERCHNO)
                oWrite.WriteLine("1911C1000880102:")
                oWrite.WriteLine("1911C1000850114" & Format(Val(MTRS), "0.00"))
                oWrite.WriteLine("1911C1000670102:")
                oWrite.WriteLine("1911C1000670114" & BALENO)
                oWrite.WriteLine("1911C1001190212GRADE :")
                oWrite.WriteLine("1911C1001190274" & PIECETYPE)
