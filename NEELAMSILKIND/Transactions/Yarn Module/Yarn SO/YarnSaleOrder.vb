...
Public Class YarnSaleOrder
    ...
    Sub getmax_YSO_no()
        Dim DTTABLE As DataTable = getmax(" isnull(max(YSO_no),0) + 1 ", "YARNSALEORDER", " and YSO_yearid=" & YearId)
    ...
    Private Sub YarnSaleOrder_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub fillcmb()
        Try
            ...
            fillunit(CMBUNIT)
            If CMBCOLOR.Text.Trim = "" Then FILLYARNCOLOR(CMBCOLOR, CMBYARNQUALITY.Text)
        Catch ex As Exception
            If ErrHandle(ex.Message.GetHashCode) = False Then Throw ex
        End Try
    End Sub

    Private Sub YarnSaleOrder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim objclsPO As New ClsYarnSaleOrder()
                ...
                If dt_po.Rows.Count > 0 Then
                    For Each dr As DataRow In dt_po.Rows
                        ...
                        GRIDSO.Rows.Add(dr("GRIDSRNO").ToString, dr("YARNQUALITY").ToString, dr("DESC").ToString, dr("SHADE").ToString, Format(Val(dr("BAGS")), "0.00"), dr("UNIT").ToString, Format(Val(dr("WT")), "0.00"), Format(Val(dr("RATE")), "0.00"), Format(Val(dr("AMT")), "0.00"), Val(dr("RECDBAGS")), Val(dr("RECDWT")), dr("DONE").ToString, dr("CLOSED"))
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            Dim objclsPurord As New ClsYarnSaleOrder()
    ...
    Sub fillgrid()
        ...
        GRIDSO.Enabled = True
        If GRIDDOUBLECLICK = False Then
            GRIDSO.Rows.Add(Val(txtsrno.Text.Trim), CMBYARNQUALITY.Text.Trim, TXTDESC.Text.Trim, CMBCOLOR.Text.Trim, Val(TXTBAGS.Text.Trim), CMBUNIT.Text.Trim, Val(TXTWT.Text.Trim), Val(TXTRATE.Text.Trim), 0, 0, 0, 0, 0)
            getsrno(GRIDSO)
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        ...
        Try
            ...
            If EDIT = True Then
                ...
                Dim clspo As New ClsYarnSaleOrder()
    ...
    Sub PRINTREPORT()
        Try
            ...
            OBJPO.FRMSTRING = "YARNSO"
            OBJPO.WHERECLAUSE = "{YARNSALEORDER.YSO_NO}=" & Val(TXTSONO.Text) & " and {YARNSALEORDER.YSO_yearid}=" & YearId
            OBJPO.Show()
        Catch ex As Exception
            Throw ex
        End Try
...
LINE1:
    ...
    Private Sub OpenToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim objINVDTLS As New YarnSaleOrderDetails
