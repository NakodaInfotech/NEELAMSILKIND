...
Partial Class YarnWastageDetails
    ...
    Private Sub InitializeComponent()
        ...
        Me.MILLNAME = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.GSTOCKWT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.GACTUALWT = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.gridbilldetails.Size = New System.Drawing.Size(1204, 505)
        ...
        Me.gridbill.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GNO, Me.GDATE, Me.GNAME, Me.GGODOWN, Me.GTYPE, Me.GQUALITY, Me.MILLNAME, Me.GCOLOR, Me.GBOXNO, Me.GLOTNO, Me.GSTOCKWT, Me.GACTUALWT, Me.GWT, Me.GLRNO, Me.GCONES, Me.GNARRATION})
        ...
        'MILLNAME
        '
        Me.MILLNAME.Caption = "Mill Name"
        Me.MILLNAME.FieldName = "MILLNAME"
        Me.MILLNAME.Name = "MILLNAME"
        Me.MILLNAME.OptionsColumn.AllowEdit = False
        Me.MILLNAME.Visible = True
        Me.MILLNAME.VisibleIndex = 5
        Me.MILLNAME.Width = 250
        '
        'GCOLOR
        '
        ...
        'GNARRATION
        '
        Me.GNARRATION.Caption = "GNARRATION"
        ...
        Me.TOOLEXCEL.Image = Global.NEELAMSILKIND.My.Resources.Resources.Excel_icon
        ...
        'GSTOCKWT
        '
        Me.GSTOCKWT.Caption = "Stock Wt"
        Me.GSTOCKWT.DisplayFormat.FormatString = "0.00"
        Me.GSTOCKWT.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.GSTOCKWT.FieldName = "STOCKWT"
        Me.GSTOCKWT.Name = "GSTOCKWT"
        Me.GSTOCKWT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum)})
        Me.GSTOCKWT.Visible = True
        Me.GSTOCKWT.VisibleIndex = 9
        '
        'GACTUALWT
        '
        Me.GACTUALWT.Caption = "Actual Wt"
        Me.GACTUALWT.DisplayFormat.FormatString = "0.00"
        Me.GACTUALWT.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.GACTUALWT.FieldName = "ACTUALWT"
        Me.GACTUALWT.Name = "GACTUALWT"
        Me.GACTUALWT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum)})
        Me.GACTUALWT.Visible = True
        Me.GACTUALWT.VisibleIndex = 10
        '
        'YarnWastageDetails
        '
        ...
        Me.KeyPreview = True
        Me.Name = "YarnWastageDetails"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.Manual
        Me.Text = "Yarn Wastage Details"
    ...
    Friend WithEvents MILLNAME As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Friend WithEvents GSTOCKWT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents GACTUALWT As DevExpress.XtraGrid.Columns.GridColumn
End Class
