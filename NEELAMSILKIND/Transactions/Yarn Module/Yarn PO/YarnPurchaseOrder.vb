...
Public Class YarnPurchaseOrder
        ...
        Try
            ...
            If EDIT = False And AUTOYARNDYEINGPROG = True Then
                For Each DR As DataRow In AUTODT.Rows
                    GRIDPO.Rows.Add(0, DR("YARNQUALITY"), "", "", DR("SHADE"), "", "", 0, "Kgs", Format(Val(DR("WT")), "0.00"), 0, 0, 0, 0, 0, 0, 0, PBSELPHOTO.Image, Val(DR("MRPNO")), Val(DR("MRPSRNO")))
                Next
                getsrno(GRIDPO)
                TOTAL()
            End If
    ...
    Sub fillgrid()
        ...
        GRIDPO.Enabled = True
        If GRIDDOUBLECLICK = False Then
            GRIDPO.Rows.Add(Val(txtsrno.Text.Trim), CMBYARNQUALITY.Text.Trim, TXTDESC.Text.Trim, CMBMILLNAME.Text.Trim, CMBCOLOR.Text.Trim, CMBGRIDNAME.Text.Trim, CMBTRANS.Text.Trim, Val(TXTBAGS.Text.Trim), CMBUNIT.Text.Trim, Val(TXTWT.Text.Trim), Val(TXTCONES.Text.Trim), Val(TXTRATE.Text.Trim), 0, 0, 0, 0, 0, 0, 0)
            getsrno(GRIDPO)
    ...
    Sub PRINTREPORT()
        Try
            ...
            OBJPO.WHERECLAUSE = "{YARNPURCHASEORDER.YPO_NO}=" & Val(TXTPONO.Text) & " and {YARNPURCHASEORDER.YPO_yearid}=" & YearId
            OBJPO.Show()
        Catch ex As Exception
            Throw ex
        End Try
