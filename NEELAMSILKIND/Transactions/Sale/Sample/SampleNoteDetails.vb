...
Public Class SampleNoteDetails
    ...
    Private Sub SAMPLENOTEMASTERDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            fillgrid(" and dbo.SAMPLENOTEMASTER.SMP_yearid=" & YearId & " order by dbo.SAMPLENOTEMASTER.SMP_NO, SAMPLENOTEMASTER_DESC.SMP_GRIDSRNO ")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Sub showform(ByVal editval As Boolean, ByVal SMPNO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objPO As New SampleNote
                objPO.MdiParent = MDIMain
                objPO.EDIT = editval
                objPO.TEMPSMPNO = SMPNO
                objPO.Show()
            End If
        Catch ex As Exception
            Throw ex
