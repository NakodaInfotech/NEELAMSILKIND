...
Public Class SaleOrderClose
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            'WE DONT WANT TO OPEN CLOSED ORDERS AS PER SIR
            If RBENTERED.Checked = True Then Exit Sub
        ...
        Try
            If RBPENDING.Checked = True Then
                If IsDBNull(gridbill.GetRowCellValue(e.RowHandle, "CLOSEDDATE")) = False Then
                    ...
                    If gridbill.GetRowCellValue(e.RowHandle, "CLOSEDDATE") <> "" Then
    ...
    Private Sub RBENTERED_CheckedChanged(sender As Object, e As EventArgs) Handles RBENTERED.CheckedChanged, RBPENDING.CheckedChanged
        fillgrid()
    End Sub
