...
Public Class JournalRegister
    ...
    Private Sub JournalRegister_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub JournalRegister_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            fillgrid()
        Catch ex As Exception
            Throw ex
    ...
    Sub fillgrid()
        Try
            ...
            Dim OBJJVREG As New ClsJournalRegister
    ...
    Sub SHOWFORM()
        Try
            Dim objJVdetails As New JournalRegisterDetails
            objJVdetails.JVREGNAME = cmbregister.Text.Trim
            objJVdetails.FromDate = getfirstdate(CmpId, gridregister.CurrentRow.Cells(0).Value.ToString)
            objJVdetails.ToDate = getlastdate(CmpId, gridregister.CurrentRow.Cells(0).Value.ToString)
            objJVdetails.MdiParent = MDIMain
            objJVdetails.Show()
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            ...
            objreg.frmstring = "JvRegisterMonthly"
    ...
    Private Sub JournalRegister_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
