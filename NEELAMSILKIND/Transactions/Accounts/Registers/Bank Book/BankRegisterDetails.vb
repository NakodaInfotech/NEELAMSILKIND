    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            ...
            If chkdate.Checked = True Then
                ...
                objreg.PERIOD = "BANK BOOK DETAILS - " & Format(dtfrom.Value, "dd/MM/yyyy") & " - " & Format(dtto.Value, "dd/MM/yyyy")
            Else
                objreg.FROMDATE = FromDate
                objreg.TODATE = ToDate
                objreg.PERIOD = "BANK BOOK DETAILS - " & Format(FromDate.Date, "dd/MM/yyyy") & " - " & Format(ToDate.Date, "dd/MM/yyyy")
            End If
