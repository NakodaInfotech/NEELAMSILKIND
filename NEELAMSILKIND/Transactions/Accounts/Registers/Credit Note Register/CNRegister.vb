...
Public Class CNRegister

    Private Sub cmdexit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdexit.Click
        Me.Close()
    End Sub

    Private Sub CNRegister_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub CNRegister_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            fillgrid()
        Catch ex As Exception
            Throw ex
    ...
    Sub fillgrid()
        Try
            ...
            Dim OBJCNREG As New ClsCNRegister
    ...
    Sub SHOWFORM()
        Try
            Dim objCNdetails As New CNRegisterDetails
            objCNdetails.CNREGNAME = cmbregister.Text.Trim
            objCNdetails.FromDate = getfirstdate(CmpId, gridregister.CurrentRow.Cells(0).Value.ToString)
            objCNdetails.ToDate = getlastdate(CmpId, gridregister.CurrentRow.Cells(0).Value.ToString)
            objCNdetails.MdiParent = MDIMain
            objCNdetails.Show()
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            ...
            objreg.frmstring = "CNRegisterMonthly"
    ...
    Private Sub CNRegister_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
