...
Public Class DNRegister
    ...
    Private Sub DNRegister_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub DNRegister_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            fillgrid()
        Catch ex As Exception
            Throw ex
    ...
    Sub fillgrid()
        Try
            ...
            Dim OBJDNREG As New ClsDNRegister
    ...
    Sub SHOWFORM()
        Try
            Dim objDNdetails As New DNRegisterDetails
            objDNdetails.DNREGNAME = cmbregister.Text.Trim
            objDNdetails.FromDate = getfirstdate(CmpId, gridregister.CurrentRow.Cells(0).Value.ToString)
            objDNdetails.ToDate = getlastdate(CmpId, gridregister.CurrentRow.Cells(0).Value.ToString)
            objDNdetails.MdiParent = MDIMain
            objDNdetails.Show()
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            ...
            objreg.frmstring = "DNRegisterMonthly"
    ...
    Private Sub DNRegister_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
