...
Public Class OpeningYarnDyeingProgram
    ...
    Sub getmax_PROG_no()
        Dim DTTABLE As DataTable = getmax(" isnull(max(PROG_no),0) + 1 ", "OPENINGYARNDYEINGPROGRAM", " and PROG_yearid=" & YearId)
    ...
    Private Sub OPENINGYARNDYEINGPROGRAM_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub OPENINGYARNDYEINGPROGRAM_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim OBJPROG As New ClsOpeningYarnDyeingProgram()
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            Dim objclsPurord As New ClsOpeningYarnDyeingProgram()
    ...
    Sub fillgrid()
        ...
        If GRIDDOUBLECLICK = False Then
            GRIDPROG.Rows.Add(Val(txtsrno.Text.Trim), CMBYARNQUALITY.Text.Trim, TXTDESC.Text.Trim, CMBMILLNAME.Text.Trim, CMBCOLOR.Text.Trim, CMBGRIDNAME.Text.Trim, CMBTRANS.Text.Trim, Val(TXTBAGS.Text.Trim), CMBUNIT.Text.Trim, Val(TXTWT.Text.Trim), Val(TXTCONES.Text.Trim), Val(TXTRATE.Text.Trim), 0, 0, 0, 0, 0)
            getsrno(GRIDPROG)
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        ...
        Try
            ...
            If EDIT = True Then
                ...
                Dim clspo As New ClsOpeningYarnDyeingProgram()
        ...
        Try
            If Val(tstxtbillno.Text.Trim) > 0 Then
                ...
                If TEMPPROGNO > 0 Then
                    EDIT = True
                    OPENINGYARNDYEINGPROGRAM_Load(sender, e)
                Else
                    CLEAR()
                    EDIT = False
                End If
    ...
    Sub PRINTREPORT()
        Try
            ...
            OBJPO.WHERECLAUSE = "{OPENINGYARNDYEINGPROGRAM.PROG_NO}=" & Val(TXTPROGNO.Text) & " and {OPENINGYARNDYEINGPROGRAM.PROG_yearid}=" & YearId
            OBJPO.Show()
        Catch ex As Exception
            Throw ex
        End Try
...
LINE1:
    ...
    Private Sub OpenToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim objINVDTLS As New OpeningYarnDyeingProgramDetails
