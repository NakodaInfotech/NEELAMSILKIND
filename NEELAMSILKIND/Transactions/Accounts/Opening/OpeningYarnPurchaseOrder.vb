...
Public Class OpeningYarnPurchaseOrder
    ...
    Sub getmax_OYPO_no()
        Dim DTTABLE As DataTable = getmax(" isnull(max(OYPO_no),0) + 1 ", "OPENINGYARNPURCHASEORDER", " and OYPO_yearid=" & YearId)
    ...
    Private Sub OpeningYarnPurchaseOrder_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub OpeningYarnPurchaseOrder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim objclsPO As New ClsOpeningYarnPurchaseOrder()
                ...
                If dt_po.Rows.Count > 0 Then
                    For Each dr As DataRow In dt_po.Rows
                        ...
                        GRIDPO.Rows.Add(dr("GRIDSRNO").ToString, dr("YARNQUALITY").ToString, dr("DESC").ToString, dr("MILLNAME").ToString, dr("SHADE").ToString, dr("GRIDNAME"), dr("TRANSNAME"), Format(Val(dr("BAGS")), "0.00"), dr("UNIT").ToString, Format(Val(dr("WT")), "0.00"), Val(dr("CONES")), Format(Val(dr("RATE")), "0.00"), Format(Val(dr("AMT")), "0.00"), Val(dr("RECDBAGS")), Val(dr("RECDWT")), dr("DONE").ToString, dr("CLOSED"), PBSELPHOTO.Image)
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            For Each row As System.WINDOWS.FORMS.DataGridViewRow In GRIDPO.Rows
            ...
            Dim objclsPurord As New ClsOpeningYarnPurchaseOrder()
    ...
    Sub fillgrid()
        ...
        GRIDPO.Enabled = True
        If GRIDDOUBLECLICK = False Then
            GRIDPO.Rows.Add(Val(txtsrno.Text.Trim), CMBYARNQUALITY.Text.Trim, TXTDESC.Text.Trim, CMBMILLNAME.Text.Trim, CMBCOLOR.Text.Trim, CMBGRIDNAME.Text.Trim, CMBTRANS.Text.Trim, Val(TXTBAGS.Text.Trim), CMBUNIT.Text.Trim, Val(TXTWT.Text.Trim), Val(TXTCONES.Text.Trim), Val(TXTRATE.Text.Trim), 0, 0, 0, 0, 0)
            getsrno(GRIDPO)
        ElseIf GRIDDOUBLECLICK = True Then
            ...
            GRIDPO.Item(GNAME.Index, TEMPROW).Value = CMBGRIDNAME.Text.Trim
            GRIDPO.Item(GTRANSNAME.Index, TEMPROW).Value = CMBTRANS.Text.Trim
    ...
    Private Sub GRIDPO_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles GRIDPO.CellDoubleClick
        If e.RowIndex >= 0 And GRIDPO.Item(gsrno.Index, e.RowIndex).Value <> Nothing Then
            ...
            CMBGRIDNAME.Text = GRIDPO.Item(GNAME.Index, e.RowIndex).Value.ToString
            CMBTRANS.Text = GRIDPO.Item(GTRANSNAME.Index, e.RowIndex).Value.ToString
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        ...
        Try
            ...
            If EDIT = True Then
                ...
                Dim clspo As New ClsOpeningYarnPurchaseOrder()
    ...
    Sub EDITROW()
        Try
            If GRIDPO.CurrentRow.Index >= 0 And GRIDPO.Item(gsrno.Index, GRIDPO.CurrentRow.Index).Value <> Nothing Then
                ...
                CMBGRIDNAME.Text = GRIDPO.Item(GNAME.Index, GRIDPO.CurrentRow.Index).Value.ToString
                CMBTRANS.Text = GRIDPO.Item(GTRANSNAME.Index, GRIDPO.CurrentRow.Index).Value.ToString
    ...
    Private Sub tstxtbillno_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles tstxtbillno.Validating
        Try
            If Val(tstxtbillno.Text.Trim) > 0 Then
                ...
                If tempono > 0 Then
                    EDIT = True
                    OpeningYarnPurchaseOrder_Load(sender, e)
                Else
                    CLEAR()
                    EDIT = False
                End If
    ...
    Sub PRINTREPORT()
        Try
            ...
            OBJPO.FRMSTRING = "YARNPO"
            OBJPO.WHERECLAUSE = "{OPENINGYARNPURCHASEORDER.OYPO_NO}=" & Val(TXTPONO.Text) & " and {OPENINGYARNPURCHASEORDER.OYPO_yearid}=" & YearId
            OBJPO.Show()
        Catch ex As Exception
            Throw ex
        End Try
...
LINE1:
    ...
    Private Sub OpenToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim objINVDTLS As New OpeningYarnPurchaseOrderDetails
    ...
    Private Sub GRIDPO_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles GRIDPO.CellClick
        PBPHOTO.Image = GRIDPO.CurrentRow.Cells(GIMGPATH.Index).Value
    End Sub
