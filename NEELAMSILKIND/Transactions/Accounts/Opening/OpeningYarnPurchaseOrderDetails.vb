...
Public Class OpeningYarnPurchaseOrderDetails
    ...
    Private Sub OpeningYarnPurchaseOrderDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub OpeningYarnPurchaseOrderDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub fillgrid()
        Try
            Dim OBJPO As New ClsOpeningYarnPurchaseOrder
    ...
    Sub showform(ByVal editval As Boolean, ByVal PONO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objPO As New OpeningYarnPurchaseOrder
