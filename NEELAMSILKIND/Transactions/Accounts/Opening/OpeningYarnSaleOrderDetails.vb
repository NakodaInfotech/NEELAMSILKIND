...
Public Class OpeningYarnSaleOrderDetails
    ...
    Private Sub OpeningYarnSaleOrderDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub OpeningYarnSaleOrderDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub fillgrid()
        Try
            Dim OBJPO As New ClsOpeningYarnSaleOrder
            Dim dt As DataTable = OBJPO.SELECTSO(0, CmpId, 0, YearId)
    ...
    Sub showform(ByVal editval As Boolean, ByVal SONO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objPO As New OpeningYarnSaleOrder
